...
public class ScalariformConfigurationForm {
    ...
    public void setData(ScalariformProjectComponent data) {
    ...
    public void getData(ScalariformProjectComponent data) {
    ...
    public boolean isModified(ScalariformProjectComponent data) {
